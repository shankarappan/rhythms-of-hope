...
export const EVENT_DOORS_TIME = "4:30 pm";
export const EVENT_SHOW_TIME = "5:00 pm";
export const EVENT_TIME = `Doors open ${EVENT_DOORS_TIME} · Show starts ${EVENT_SHOW_TIME}`;
export const EVENT_VENUE = "Te Whare Maui Event Centre";
export const EVENT_ADDRESS = "21 Maui Street, Pukete, Hamilton 3200";
